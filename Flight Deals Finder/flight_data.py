...
def find_cheapest_flight(data):
    ...
    number_stops = len(first_flight["itineraries"][0]["segments"]) - 1

    cheapest_flight = FlightData(lowest_price, origin, destination, out_date, return_date, number_stops)
    ...
    for flight in data["data"]:
        ...
        if (price < lowest_price):
                ...
                destination = flight["itineraries"][0]["segments"][number_stops]["arrival"]["iataCode"]
